...
class HalfCheetahModifiedMultiEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
...
class HalfCheetahModifiedDampingEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
...
class HalfCheetahModifiedStiffnessEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
...
class HalfCheetahModifiedJointFrictionEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
...
class HalfCheetahModifiedGroundFrictionEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
...
class HalfCheetahModifiedMotorEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
...
class HalfCheetahModifiedMassEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
